...
public class Biome extends VersionedGen {
    ...
    public static final Biome OCEAN = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 0, "ocean", Category.OCEAN, Precipitation.RAIN, 0.5F, 0.100F, -1.000F, null);
    public static final Biome PLAINS = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 1, "plains", Category.PLAINS, Precipitation.RAIN, 0.8F, 0.050F, 0.125F, null);
    public static final Biome DESERT = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 2, "desert", Category.DESERT, Precipitation.NONE, 2.0F, 0.050F, 0.125F, null);
    public static final Biome MOUNTAINS = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 3, "mountains", Category.EXTREME_HILLS, Precipitation.RAIN, 0.2F, 0.500F, 1.000F, null);
    public static final Biome FOREST = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 4, "forest", Category.FOREST, Precipitation.RAIN, 0.7F, 0.200F, 0.100F, null);
    public static final Biome TAIGA = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 5, "taiga", Category.TAIGA, Precipitation.RAIN, 0.25F, 0.200F, 0.200F, null);
    public static final Biome SWAMP = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 6, "swamp", Category.SWAMP, Precipitation.RAIN, 0.8F, 0.100F, -0.200F, null);
    public static final Biome RIVER = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 7, "river", Category.RIVER, Precipitation.RAIN, 0.5F, 0.000F, -0.500F, null);
    public static final Biome NETHER_WASTES = new Biome(MCVersion.v1_0, Dimension.NETHER, 8, "nether_wastes", Category.NETHER, Precipitation.NONE, 2.0F, 0.200F, 0.100F, null);
    public static final Biome THE_END = new Biome(MCVersion.v1_0, Dimension.END, 9, "the_end", Category.THE_END, Precipitation.NONE, 0.5F, 0.200F, 0.100F, null);
    public static final Biome FROZEN_OCEAN = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 10, "frozen_ocean", Category.OCEAN, Precipitation.SNOW, 0.0F, 0.100F, -1.000F, null);
    public static final Biome FROZEN_RIVER = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 11, "frozen_river", Category.RIVER, Precipitation.SNOW, 0.0F, 0.000F, -0.500F, null);
    public static final Biome SNOWY_TUNDRA = new Biome(MCVersion.v1_0, Dimension.OVERWORLD, 12, "snowy_tundra", Category.ICY, Precipitation.SNOW, 0.0F, 0.050F, 0.125F, null);
    ...
    public static final Biome STONE_SHORE = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 25, "stone_shore", Category.NONE, Precipitation.RAIN, 0.2F, 0.800F, 0.100F, null);
    public static final Biome SNOWY_BEACH = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 26, "snowy_beach", Category.BEACH, Precipitation.SNOW, 0.05F, 0.025F, 0.000F, null);
    public static final Biome BIRCH_FOREST = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 27, "birch_forest", Category.FOREST, Precipitation.RAIN, 0.6F, 0.200F, 0.100F, null);
    public static final Biome BIRCH_FOREST_HILLS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 28, "birch_forest_hills", Category.FOREST, Precipitation.RAIN, 0.6F, 0.300F, 0.450F, null);
    public static final Biome DARK_FOREST = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 29, "dark_forest", Category.FOREST, Precipitation.RAIN, 0.7F, 0.200F, 0.100F, null);
    public static final Biome SNOWY_TAIGA = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 30, "snowy_taiga", Category.TAIGA, Precipitation.SNOW, -0.5F, 0.200F, 0.200F, null);
    public static final Biome SNOWY_TAIGA_HILLS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 31, "snowy_taiga_hills", Category.TAIGA, Precipitation.SNOW, -0.5F, 0.300F, 0.450F, null);
    public static final Biome GIANT_TREE_TAIGA = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 32, "giant_tree_taiga", Category.TAIGA, Precipitation.RAIN, 0.3F, 0.200F, 0.200F, null);
    public static final Biome GIANT_TREE_TAIGA_HILLS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 33, "giant_tree_taiga_hills", Category.TAIGA, Precipitation.RAIN, 0.3F, 0.300F, 0.450F, null);
    public static final Biome WOODED_MOUNTAINS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 34, "wooded_mountains", Category.EXTREME_HILLS, Precipitation.RAIN, 0.2F, 0.500F, 1.000F, null);
    public static final Biome SAVANNA = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 35, "savanna", Category.SAVANNA, Precipitation.NONE, 1.2F, 0.050F, 0.125F, null);
    public static final Biome SAVANNA_PLATEAU = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 36, "savanna_plateau", Category.SAVANNA, Precipitation.NONE, 1.0F, 0.025F, 1.500F, null);
    public static final Biome BADLANDS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 37, "badlands", Category.MESA, Precipitation.NONE, 2.0F, 0.200F, 0.100F, null);
    public static final Biome WOODED_BADLANDS_PLATEAU = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 38, "wooded_badlands_plateau", Category.MESA, Precipitation.NONE, 2.0F, 0.025F, 1.500F, null);
    public static final Biome BADLANDS_PLATEAU = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 39, "badlands_plateau", Category.MESA, Precipitation.NONE, 2.0F, 0.025F, 1.500F, null);
    ...
    public static final Biome ICE_SPIKES = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 140, "ice_spikes", Category.ICY, Precipitation.SNOW, 0.0F, 0.450F, 0.425F, Biome.SNOWY_TUNDRA);
    public static final Biome MODIFIED_JUNGLE = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 149, "modified_jungle", Category.JUNGLE, Precipitation.RAIN, 0.95F, 0.400F, 0.200F, Biome.JUNGLE);
    public static final Biome MODIFIED_JUNGLE_EDGE = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 151, "modified_jungle_edge", Category.JUNGLE, Precipitation.RAIN, 0.95F, 0.400F, 0.200F, Biome.JUNGLE_EDGE);
    public static final Biome TALL_BIRCH_FOREST = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 155, "tall_birch_forest", Category.FOREST, Precipitation.RAIN, 0.6F, 0.400F, 0.200F, Biome.BIRCH_FOREST);
    public static final Biome TALL_BIRCH_HILLS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 156, "tall_birch_hills", Category.FOREST, Precipitation.RAIN, 0.6F, 0.500F, 0.550F, Biome.BIRCH_FOREST_HILLS);
    public static final Biome DARK_FOREST_HILLS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 157, "dark_forest_hills", Category.FOREST, Precipitation.RAIN, 0.7F, 0.400F, 0.200F, Biome.DARK_FOREST);
    public static final Biome SNOWY_TAIGA_MOUNTAINS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 158, "snowy_taiga_mountains", Category.TAIGA, Precipitation.SNOW, -0.5F, 0.400F, 0.300F, Biome.SNOWY_TAIGA);
    public static final Biome GIANT_SPRUCE_TAIGA = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 160, "giant_spruce_taiga", Category.TAIGA, Precipitation.RAIN, 0.25F, 0.200F, 0.200F, Biome.GIANT_TREE_TAIGA);
    public static final Biome GIANT_SPRUCE_TAIGA_HILLS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 161, "giant_spruce_taiga_hills", Category.TAIGA, Precipitation.RAIN, 0.25F, 0.200F, 0.200F, Biome.GIANT_TREE_TAIGA_HILLS);
    public static final Biome MODIFIED_GRAVELLY_MOUNTAINS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 162, "modified_gravelly_mountains", Category.EXTREME_HILLS, Precipitation.RAIN, 0.2F, 0.500F, 1.000F, Biome.WOODED_MOUNTAINS);
    public static final Biome SHATTERED_SAVANNA = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 163, "shattered_savanna", Category.SAVANNA, Precipitation.NONE, 1.1F, 1.225F, 0.362F, Biome.SAVANNA);
    public static final Biome SHATTERED_SAVANNA_PLATEAU = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 164, "shattered_savanna_plateau", Category.SAVANNA, Precipitation.NONE, 1.0F, 1.212F, 1.050F, Biome.SAVANNA_PLATEAU);
    public static final Biome ERODED_BADLANDS = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 165, "eroded_badlands", Category.MESA, Precipitation.NONE, 2.0F, 0.200F, 0.100F, Biome.BADLANDS);
    public static final Biome MODIFIED_WOODED_BADLANDS_PLATEAU = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 166, "modified_wooded_badlands_plateau", Category.MESA, Precipitation.NONE, 2.0F, 0.300F, 0.450F, Biome.WOODED_BADLANDS_PLATEAU);
    public static final Biome MODIFIED_BADLANDS_PLATEAU = new Biome(MCVersion.v1_7_2, Dimension.OVERWORLD, 167, "modified_badlands_plateau", Category.MESA, Precipitation.NONE, 2.0F, 0.300F, 0.450F, Biome.BADLANDS_PLATEAU);
