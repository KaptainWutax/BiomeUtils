...
public class OverworldBiomeSource extends BiomeSource {
	...
	public OverworldBiomeSource build() {
		...
		this.base = new CurveLayer(this.getWorldSeed(), 1L, this.base);
		this.base = new ScaleLayer(this.getWorldSeed(), 2001L, ScaleLayer.Type.NORMAL, this.base);
		this.base = new CurveLayer(this.getWorldSeed(), 2L, this.base);
		this.base = new CurveLayer(this.getWorldSeed(), 50L, this.base);
		this.base = new CurveLayer(this.getWorldSeed(), 70L, this.base);
		this.base = new IslandLayer(this.getWorldSeed(), 2L, this.base);
		this.base = new ClimateLayer.Cold(this.getWorldSeed(), 2L, this.base);
		this.base = new CurveLayer(this.getWorldSeed(), 3L, this.base);
		...
		this.base = new CurveLayer(this.getWorldSeed(), 4L, this.base);
		...
		this.noise = new SimpleLandNoiseLayer(this.getWorldSeed(), 100L, this.base);
		...
		for(int i = 0; i < this.biomeSize; i++) {
			...
			if(i == 0)this.full = new CurveLayer(this.getWorldSeed(), 3L, this.full);
