...
public class BiomeSource {
	...
	public BiomeSource init() {
		...
		this.base = new LandLayer(this.worldSeed, 1L, this.base);
		this.base = new ScaleLayer(this.worldSeed, 2001L, ScaleLayer.Type.NORMAL, this.base);
		this.base = new LandLayer(this.worldSeed, 2L, this.base);
		this.base = new LandLayer(this.worldSeed, 50L, this.base);
		this.base = new LandLayer(this.worldSeed, 70L, this.base);
		this.base = new IslandLayer(this.worldSeed, 2L, this.base);
		this.base = new ClimateLayer.Cold(this.worldSeed, 2L, this.base);
		this.base = new LandLayer(this.worldSeed, 3L, this.base);
		...
		this.base = new LandLayer(this.worldSeed, 4L, this.base);
		...
		this.noise = new NoiseLayer(this.worldSeed, 100L, this.base);
		...
		for(int i = 0; i < this.biomeSize; i++) {
			...
			if(i == 0)this.full = new LandLayer(this.worldSeed, 3L, this.full);
