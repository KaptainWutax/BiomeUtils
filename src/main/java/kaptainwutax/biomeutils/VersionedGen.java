...
public class VersionedGen {
    ...
    public final VersionGate is1_1up = () -> this.getVersion().isNewerOrEqualTo(MCVersion.v1_1); // everything after  1.1
    public final VersionGate is1_3down = () -> this.getVersion().isOlderOrEqualTo(MCVersion.v1_2_5); // everything after  1.1
